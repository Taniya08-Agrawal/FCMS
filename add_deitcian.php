...
input[type=text]:focus {
  ...
  outline: none;
    ...
    <title>Enrolling Deitcian</title>
  </head>
  <body id="body">
    <div class="container">
      <nav class="navbar">
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST") {
         if(isset($_POST['insert'])==true){
          ...
          $deitcian_name = mysqli_real_escape_string($db,$_POST['deitcian_name']);
          ...
          $sql="INSERT INTO deitcian(deitcian_id,deitcian_name,DOB,Gender,Contact_no,centre_id,salary,address) values('$deitcian_id','$deitcian_name','$DOB','$Gender','$Contact_no','$centre_id','$salary','$address')";
...
<?php      
    ...
    ?>
      ...
      <h1 align="center" style="font-size:35px; font-family: cursive; color:rgb(173, 3, 3);">Deitcian Details</h1>
        <p>Please fill in this form to create a deitcian account.</p>
        <hr>
        <label for="deitcian_id">
          <b style="font-size: 20px; font-family: cursive; color:#004d00;">Deitcian id</b>
          <input type="number" placeholder="Enter deitcian id" name="deitcian_id" required>
        </label>
        <label for="deitcian_name">
          <b style="font-size: 20px; font-family: cursive; color:#004d00;">Deitcian name</b>
          <input type="text" placeholder="Enter deitcian name" name="deitcian_name" required title="Name should only contain alphabets" required>
        </label>
        <label for="DOB">
        ...
        <div class="submit">
          <button type="submit" onclick="typeWriter()" class="submitbtn" name="insert">Add deitcian</button>
          <p id="demo"></p>
        </div>
    </form>
        </div>
