    ...
    <div class="container">
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST") {
         if(isset($_POST['insert'])==true){
          ...
          $sql="INSERT INTO centre(centre_id,location) values('$centre_id','$location')";
...
?>
      ...
      <h1 align="center" style="font-size:35px; font-family: cursive; color:rgb(173, 3, 3);">Centre Details</h1>
        <p>Please fill in this form to create a centre account.</p>
        <hr>
        <label for="centre_id">
        ...
        <label for="location">
          <b style="font-size: 20px; font-family: cursive; color:#004d00;">location</b>
          <input type="text" placeholder="Enter location" name="location" required>
        </label>
        <div class="submit">
          <button type="submit" onclick="typeWriter()" class="submitbtn" name="insert">Add Centre</button>
          <p id="demo"></p>
        </div>
    </form>
        </div>
