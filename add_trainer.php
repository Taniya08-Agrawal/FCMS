    ...
    <div class="container">
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST") {
         if(isset($_POST['insert'])==true){
          ...
          $sql="INSERT INTO trainer(trainer_id,trainer_name,DOB,Gender,Contact_no,centre_id,salary,address) values('$trainer_id','$trainer_name','$DOB','$Gender','$Contact_no','$centre_id','$salary','$address')";
...
<?php      
    ...
    ?>
      ...
      <h1 align="center" style="font-size:35px; font-family: cursive; color:rgb(173, 3, 3);">Trainer Details</h1>
        <p>Please fill in this form to create a trainer account.</p>
        <hr>
        <label for="trainer_id">
          <b style="font-size: 20px; font-family: cursive; color:#004d00;">Trainer id</b>
          <input type="number" placeholder="Enter trainer id" name="trainer_id" required>
        </label>
        <label for="trainer_name">
          <b style="font-size: 20px; font-family: cursive; color:#004d00;">Trainer name</b>
        ...
        <div class="submit">
          <button type="submit" onclick="typeWriter()" class="submitbtn" name="insert">Add Trainer</button>
          <p id="demo"></p>
        </div>
    </form>
        </div>
