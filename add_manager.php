    ...
    <div class="container">
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST") {
         if(isset($_POST['insert'])==true){
          ...
          $mgr_name = mysqli_real_escape_string($db,$_POST['mgr_name']);
          ...
          $sql="INSERT INTO manager(manager_id,mgr_name,DOB,Gender,Contact_no,centre_id,salary,address) values('$manager_id','$mgr_name','$DOB','$Gender','$Contact_no','$centre_id','$salary','$address')";
...
<?php      
    ...
    ?>
      ...
      <h1 align="center" style="font-size:35px; font-family: cursive; color:rgb(173, 3, 3);">Manager Details</h1>
        <p>Please fill in this form to create a manager account.</p>
        <hr>
        <label for="manager_id">
          <b style="font-size: 20px; font-family: cursive; color:#004d00;">Manager id</b>
          <input type="number" placeholder="Enter manager id" name="manager_id" required>
        </label>
        <label for="mgr_name">
          <b style="font-size: 20px; font-family: cursive; color:#004d00;">Manager name</b>
          <input type="text" placeholder="Enter manager name" name="mgr_name" required>
        </label>
        <label for="DOB">
        ...
        <div class="submit">
          <button type="submit" onclick="typeWriter()" class="submitbtn" name="insert">Add Manager</button>
          <p id="demo"></p>
        </div>
    </form>
        </div>
