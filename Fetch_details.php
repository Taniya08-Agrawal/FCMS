    ...
    <div class="container">
      ...
      <main>
        <div class='container3' >
          <h1 align="center" style="font-size:35px; font-family: cursive; color:rgb(192, 0, 0);">Fetch Details for....</h1>
          <div class="row">
            <div class="column" >
              <form action="centre_details.php" method="POST">
                <button style="font-family: cursive;" align="center" class="button" type="submit">Centre</button>
              </form>
             </div>
            <div class="column"> <form action="membership_details.php" method="POST">
              <button  class="button1" style="font-family: cursive;" type="submit">Membership</button>
            </form></div>
            <div class="column"><form action="customer_details.php" method="POST">
              <button  class="button2">Customer</button>
            </form></div>
          </div>
          <div class="row2">
            <div class="column2"><form action="batch_details.php" method="POST">
              <button  class="button3" style="font-family: cursive;"type="submit">Batches</button>
            </form></div>
            <div class="column2"><form action="equipment_details.php" method="POST">
              <button  class="button4" style="font-family: cursive;" type="submit">Equipments</button>
            </form></div>
            <div class="column2"><form action="manager_details.php" method="POST">
              <button  class="button5" style="font-family: cursive">Manager</button>
            </form></div>
          </div>
          <div class="row3">
            <div class="column3"><form action="receptionist_details.php" method="POST">
              <button  class="button6" style="font-family: cursive;" type="submit">Receptionist</button>
            </form></div>
            <div class="column3"> <form action="trainer_details.php" method="POST">
              <button  class="button7"style="font-family: cursive" >Trainer</button>
            </form></div>
            <div class="column3"><form action="deitcian_details.php" method="POST">
